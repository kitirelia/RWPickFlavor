...
spec.requires_arc = true
  ...
  spec.author             = { "Kitiwat Chanluthin" => "kitiwat.sv@gmail.com" }
  # Or just: spec.author    = "Kitiwat Chanluthin"
  # spec.authors            = { "Kitiwat Chanluthin" => "kitiwat.sv@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Kitiwat Chanluthin"
  ...
  # spec.xcconfig = { "HEADER_SEARCH_PATHS" => "$(SDKROOT)/usr/include/libxml2" }
   spec.dependency 'Alamofire', '~> 4.7'
    ...
    spec.dependency 'QRCodeReader.swift', '~> 10.1'
